...
public abstract class EObjectClasspathProvider {
  public static ClassLoader getClassLoader(final EObject object) {
        ...
        if (resourceSet instanceof XtextResourceSet) {
          ...
          if (!_matched_1) {
            if (ctx instanceof IJavaProject) {
              ...
              ClassLoader _classLoader = EObjectClasspathProvider.class.getClassLoader();
              URLClassLoader _uRLClassLoader = new URLClassLoader(_resolveProject, _classLoader);
              _switchResult_1 = _uRLClassLoader;
            }
          }
          if (!_matched_1) {
            Class<? extends Object> _class = ctx.getClass();
            ClassLoader _classLoader = _class.getClassLoader();
            _switchResult_1 = _classLoader;
          }
